...
function Nevbar() {
  return (
    <>
        <nav class="bg-white top-0 border-gray-200 fixed dark:bg-gray-900  w-full">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="" class="flex items-center">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoiPw0pzLEt6mCkQ9yTiuLx6NOFxm0rXpiFw&usqp=CAU" class="h-8 rounded-2xl mr-3" alt=" Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">GeekFood</span>
    </a>
